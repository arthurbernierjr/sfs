...
## [Click Here For Guided Video](https://generalassembly.wistia.com/medias/ynta3qsajf)
...
🤔 For future reference, it's worthwhile to remember that we use the `value` property to get/set the text of an `<input>` element.
