...
- _Hyper_ is also known as a _shell_.  The default shell in Mac OS X is _Bash_. You will find the terms _terminal_ and _bash_ often used interchangeably
...
## Going Forward
- Today, we have only scratched the surface of tools such as _Hyper_ and _VS Code_
