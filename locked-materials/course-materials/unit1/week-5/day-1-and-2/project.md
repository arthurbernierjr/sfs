...
☐ **Be deployed online** using GitHub Pages or Netlify so that the rest of the world can play your game!
...
**Only the above games are approved.  Any deviation, which is extremely discouraged (officially by GA), must receive approval from your instructor before starting your planning (wireframes & pseudocode)!**

### Personally I am cool with you doing something completely different that you come up with
...
- **The BEST advice is to follow the guidelines and principles in the** [Guide to Building a Browser App](./guide). The guide will give you a step-by-step process to get you started and its MVC design pattern will result in clearer, more concise code that can scale functionality more easily.
...
- Review and check regularly the [Project 1 Code Review](/downloads/project-1-code-review.pdf) to ensure that your project is going to meet the minimum requirements.
...
- Your instructors will be using the [Project 1 Code Review](/downloads/project-1-code-review.pdf) form to determine whether or not the project passes all of the minimum requirements.
- Your instructors will endeavor to deliver your code review by EOD Thursday following Saturday's presentation.
